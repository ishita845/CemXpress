...
import { X, ShoppingCart, Package, AlertTriangle, CheckCircle } from "lucide-react";
...
export function PurchaseModal({ material, onClose, onSuccess }: PurchaseModalProps) {
  ...
  if (!user || loadingShop) return null;
  if (!shop) return null;
  ...
  const handlePurchase = async () => {
    ...
    try {
      // Create an enquiry as the "order" record (no separate Purchase collection)
      await createEnquiry({
        buyerId: user.id,
        buyerName: user.name,
        ...
        message: `Quick purchase request for ${quantity} ${material.unit} of ${material.name}. Total: ₹${totalAmount.toFixed(2)}`,
      });
            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <input
                    ...
                    value={quantity}
                    onChange={(e) => {
                      const val = parseInt(e.target.value) || material.minOrder;
              ...
              <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-4 mb-6">
                ...
                {material.discount && (
                  <div className="flex justify-between text-sm mb-2 text-green-600">
                    ...
                    <span>−₹{(material.price * quantity - totalAmount).toFixed(2)}</span>
                  </div>
                )}
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/60 rounded-xl p-3 mb-6">
                <p className="text-xs text-blue-700 dark:text-blue-400">
                  <strong>Note:</strong> This creates an order enquiry. In production, this would
