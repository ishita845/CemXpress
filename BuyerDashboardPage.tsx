      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {[
            ...
            { label: "Purchases", value: myReviews.length, icon: <ShoppingBag className="w-5 h-5" />, color: "text-green-500", bg: "bg-green-50 dark:bg-green-900/30", change: `${reviews.filter((p) => p.status === "pending").length} pending`, up: true },
